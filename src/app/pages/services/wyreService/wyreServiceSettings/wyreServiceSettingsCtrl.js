(function () {
    ...
    angular.module('BlurAdmin.pages.services.wyreService.wyreServiceSettings')
        .controller('WyreServiceSettingsCtrl', WyreServiceSettingsCtrl);

    /** @ngInject */
    function WyreServiceSettingsCtrl($rootScope,$scope,localStorageManagement,$http,$ngConfirm,environmentConfig,
        ...
        vm.serviceUrl = null;
        vm.serviceId = null;
        var serviceName = "wyre_service";
        $rootScope.dashboardTitle = 'Wyre Extension | Moxey';
        $scope.wyreSettingView = '';
        $scope.deactivatingWyre = false;
        ...
        $scope.goToWyreServiceSetting = function (setting) {
            $scope.wyreSettingView = setting;
        };        

        $scope.deactivateWyreServiceConfirm = function () {
            $ngConfirm({
                // title: 'Deactivate service',
                title: 'Deactivate extension',
                contentUrl: 'app/pages/services/wyreService/wyreServiceSettings/wyreServiceDeactivation/wyreDeactivationPrompt.html',
                animationBounce: 1,
                animationSpeed: 100,
                scope: $scope,
                buttons: {
        ...
        $scope.deactivateWyreService = function () {
            if(vm.token) {
                $scope.deactivatingWyre = true;
        ...
        vm.fetchServiceUrl = function(serviceName){
            ...
            .then(function(serviceUrl){
                ...
                vm.serviceId = JSON.parse(localStorageManagement.getValue('extensionsList'))["wyre_service"].id;
                $scope.goToWyreServiceSetting('settings');
