(function () {
    ...
    /** @ngInject */
    function BitcoinServiceTransactionsCtrl($rootScope, $scope,$http,localStorageManagement,$uibModal,toastr,multiOptionsFilterService,$location,currenciesList,
                                            errorHandler,$state,$window,typeaheadService,serializeFiltersService,$intercom,extensionsHelper) {
