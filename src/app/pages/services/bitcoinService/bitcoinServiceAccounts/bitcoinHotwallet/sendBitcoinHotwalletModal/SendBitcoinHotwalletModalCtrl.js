(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinService.bitcoinServiceAccounts')
        .controller('SendBitcoinHotwalletModalCtrl', SendBitcoinHotwalletModalCtrl);

    function SendBitcoinHotwalletModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler,hotWalletCurrencies,currencyModifiers,extensionsHelper,$location) {
        ...
        $scope.sendCurrency = $scope.hotWalletCurrencies.find(function(currency){
            return currency.currency.code === 'XBT';
        });
