(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinService.bitcoinServiceAccounts')
        .controller('AddBitcoinHdKeyCtrl', AddBitcoinHdKeyCtrl);

    /** @ngInject */
    function AddBitcoinHdKeyCtrl($scope,$http,localStorageManagement,toastr,errorHandler,$ngConfirm,$uibModalInstance,extensionsHelper,$location) {
