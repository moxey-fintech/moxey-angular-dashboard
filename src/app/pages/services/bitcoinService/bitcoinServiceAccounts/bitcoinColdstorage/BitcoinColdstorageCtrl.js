(function () {
    ...
    /** @ngInject */
    function BitcoinColdstorageCtrl($scope,localStorageManagement,errorHandler,currenciesList,$http,$uibModal,$location,multiOptionsFilterService,$state,
        ...
        if(vm.serviceUrl.indexOf('bitcoin-testnet') > 0){
            ...
            serviceName = "bitcoin_testnet_service";
        } else {
            $scope.inTestnetService = false;
            serviceName = "bitcoin_service";
        }        
