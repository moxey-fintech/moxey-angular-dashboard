(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinTestnetService.bitcoinTestnetServiceSettings')
        .controller('BitcoinTestnetHdKeysCtrl', BitcoinTestnetHdKeysCtrl);

    /** @ngInject */
    function BitcoinTestnetHdKeysCtrl($scope,$http,localStorageManagement,toastr,errorHandler,extensionsHelper,$location,$ngConfirm) {
