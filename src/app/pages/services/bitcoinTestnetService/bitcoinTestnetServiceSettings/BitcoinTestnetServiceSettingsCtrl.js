(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinTestnetService.bitcoinTestnetServiceSettings')
        .controller('BitcoinTestnetServiceSettingsCtrl', BitcoinTestnetServiceSettingsCtrl)
    ...
    function BitcoinTestnetServiceSettingsCtrl($rootScope,$scope,localStorageManagement,$http,$ngConfirm,environmentConfig,$state,extensionsHelper,
        ...
        $scope.goToBitcoinTestnetSetting = function (setting) {
            $scope.bitcoinTestnetSettingView = setting;
        };
        ...
        $scope.deactivateBitcoinServiceConfirm = function () {
            $ngConfirm({
                ...
                contentUrl: 'app/pages/services/bitcoinTestnetService/bitcoinTestnetServiceSettings/bitcoinTestnetDeactivation/bitcoinTestnetDeactivationPrompt.html',
                animationBounce: 1,
                animationSpeed: 100,
                scope: $scope,
                buttons: {
        ...
        vm.fetchServiceUrl = function(serviceName){
            extensionsHelper.getActiveServiceUrl(serviceName)
                .then(function(serviceUrl){
                    ...
                    $scope.goToBitcoinTestnetSetting('settings');
                    vm.initialize();
                    vm.getAllSubtypes();
