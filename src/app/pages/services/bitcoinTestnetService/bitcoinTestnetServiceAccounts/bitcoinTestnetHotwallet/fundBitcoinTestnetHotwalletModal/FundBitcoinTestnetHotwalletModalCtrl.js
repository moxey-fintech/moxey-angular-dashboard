(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinTestnetService.bitcoinTestnetServiceAccounts')
        .controller('FundBitcoinTestnetHotwalletModalCtrl', FundBitcoinTestnetHotwalletModalCtrl);

    function FundBitcoinTestnetHotwalletModalCtrl($scope,toastr,$http,localStorageManagement,errorHandler,extensionsHelper,$location) {
