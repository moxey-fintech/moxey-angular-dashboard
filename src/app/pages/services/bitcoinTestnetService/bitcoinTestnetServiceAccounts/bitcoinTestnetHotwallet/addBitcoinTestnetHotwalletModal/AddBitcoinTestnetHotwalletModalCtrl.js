(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinTestnetService.bitcoinTestnetServiceAccounts')
        .controller('AddBitcoinTestnetHotwalletModalCtrl', AddBitcoinTestnetHotwalletModalCtrl);

    function AddBitcoinTestnetHotwalletModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler,$location,extensionsHelper) {
