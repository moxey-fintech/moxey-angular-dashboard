(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinTestnetService.bitcoinTestnetServiceAccounts')
        .controller('AddTestnetPublicAddressModalCtrl', AddTestnetPublicAddressModalCtrl);

    function AddTestnetPublicAddressModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler,extensionsHelper,$location) {
