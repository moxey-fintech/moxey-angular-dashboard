(function () {
    ...
    angular.module('BlurAdmin.pages.services.bitcoinTestnetService.bitcoinTestnetServiceUsers')
        .controller('BitcoinTestnetServiceUsersCtrl', BitcoinTestnetServiceUsersCtrl);

    /** @ngInject */
    function BitcoinTestnetServiceUsersCtrl($rootScope, $scope,$http,typeaheadService,extensionsHelper, $location,
