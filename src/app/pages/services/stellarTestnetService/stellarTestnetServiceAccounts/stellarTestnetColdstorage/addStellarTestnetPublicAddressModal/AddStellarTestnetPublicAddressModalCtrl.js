(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('AddStellarTestnetPublicAddressModalCtrl', AddStellarTestnetPublicAddressModalCtrl);

    function AddStellarTestnetPublicAddressModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler,$location,extensionsHelper) {
