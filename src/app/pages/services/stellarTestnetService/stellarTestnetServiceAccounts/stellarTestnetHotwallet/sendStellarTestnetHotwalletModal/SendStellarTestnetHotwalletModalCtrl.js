(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('SendStellarTestnetHotwalletModalCtrl', SendStellarTestnetHotwalletModalCtrl);

    function SendStellarTestnetHotwalletModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler,hotWalletCurrencies,currencyModifiers,
