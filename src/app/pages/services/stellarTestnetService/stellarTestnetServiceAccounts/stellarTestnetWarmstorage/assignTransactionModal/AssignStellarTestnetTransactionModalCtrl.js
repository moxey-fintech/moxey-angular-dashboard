(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('AssignStellarTestnetTransactionModalCtrl', AssignStellarTestnetTransactionModalCtrl);

    function AssignStellarTestnetTransactionModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler,typeaheadService,transaction,$location,extensionsHelper) {
