(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAccounts')
        .controller('DisplayStellarTestnetUnAssignedTxnModalCtrl', DisplayStellarTestnetUnAssignedTxnModalCtrl);

    function DisplayStellarTestnetUnAssignedTxnModalCtrl($scope,$uibModal,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler, unassignedTxn,$location,extensionsHelper) {
