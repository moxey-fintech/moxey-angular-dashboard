(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarTestnetService.stellarTestnetServiceAssets')
        .controller('AddStellarTestnetAssetsModalCtrl', AddStellarTestnetAssetsModalCtrl);

    function AddStellarTestnetAssetsModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler,$location,extensionsHelper,$ngConfirm) {
        ...
        $scope.isCustomAsset = false;
        // var horizonServer = new StellarSdk.Server('https://horizon-testnet.stellar.org');
        ...
        $scope.confirmAddingNewAsset = function(){
            $ngConfirm({
                title: 'Confirmation',
                contentUrl: "app/pages/services/stellarTestnetService/stellarTestnetServiceAssets/addStellarTestnetAssetsModal/addStellarTestnetAssetConfirmationModal.html",
                animationBounce: 1,
                animationSpeed: 100,
                columnClass: 'large',
                scope: $scope,
