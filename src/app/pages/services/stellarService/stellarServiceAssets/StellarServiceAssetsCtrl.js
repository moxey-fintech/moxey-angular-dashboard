(function () {
    ...
    /** @ngInject */
    function StellarServiceAssetsCtrl($scope,localStorageManagement,environmentConfig,$filter,$http,errorHandler,$uibModal,toastr,$location,extensionsHelper) {
