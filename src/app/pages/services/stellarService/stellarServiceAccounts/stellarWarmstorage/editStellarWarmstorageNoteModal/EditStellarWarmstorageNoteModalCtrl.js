(function () {
    ...
    angular.module('BlurAdmin.pages.services.stellarService.stellarServiceAccounts')
        .controller('EditStellarWarmstorageNoteModalCtrl', EditStellarWarmstorageNoteModalCtrl);

    function EditStellarWarmstorageNoteModalCtrl($scope,$uibModalInstance,toastr,$http,localStorageManagement,errorHandler, primaryAccount,$location,extensionsHelper) {
