(function () {
    ...
    function StellarSettingsCtrl($rootScope,$scope,localStorageManagement,$http,$ngConfirm,environmentConfig,$state,extensionsHelper,
                ...
                buttons: {
                    Add: {
                        ...
                        action: function(scope){
                            scope.deactivateStellarService();
                        }
                    },
                    close: {
                        text: "Cancel",
        ...
        $scope.deactivateStellarService = function () {
            if(vm.token) {
        ...
        $scope.addStellarFederationAddress = function(){
        ...
        vm.updateStellarSubtypes = function(stellarSubtypes){
            if(vm.token){
                $scope.loadingSubtypes = true;
                $http.patch(vm.serviceUrl + 'admin/company/configuration/', stellarSubtypes, {
                    headers: {
                        'Content-type': 'application/json',
                        'Authorization': vm.token
                    }
        ...
        $scope.openAddGroupModal = function () {
            $state.go('groups.overview', {externalCall: "stellar"});
        };
        ...
        $scope.downloadStellarTOMLFile = function(){
            if(vm.token){
        ...
        vm.fetchServiceUrl = function(serviceName){
            ...
            .then(function(serviceUrl){
                ...
                $scope.goToStellarSetting('federation-address');
                vm.initialize();
